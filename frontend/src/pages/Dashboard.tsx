      ...
      <div className="card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button 
            ...
            className="btn-accent text-left flex items-center space-x-4 justify-start"
          >
            <div className="w-10 h-10 bg-white bg-opacity-30 rounded-xl flex items-center justify-center flex-shrink-0">
