        ...
        <div className="flex flex-col h-full">
          ...
          <div className="px-8 py-8 border-b border-gray-200">
            <div className="flex items-center space-x-3">
              ...
              />
              <h1 className="text-2xl font-bold text-primary-700">Tawasol CRM</h1>
            </div>
          </div>
          ...
          <nav className="flex-1 px-5 py-8 space-y-2 overflow-y-auto">
            <Link
              ...
              className={`flex items-center space-x-4 px-5 py-4 rounded-xl transition-all duration-200 ${
                isActive('/dashboard')
                  ? 'bg-gradient-to-r from-primary-50 to-primary-100 text-primary-800 shadow-sm font-semibold'
