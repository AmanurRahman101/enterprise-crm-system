  ...
  return (
    <div className="p-4 md:p-6 lg:p-8">
      {loading ? (
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-8">
            <div className="glass-card rounded-xl p-4 md:p-6 border-l-4 border-teal-500 hover:shadow-2xl hover:shadow-teal-500/10 transition-all transform hover:-translate-y-1">
            ...
            <div className="glass-card rounded-xl p-4 md:p-6 border-l-4 border-emerald-500 hover:shadow-2xl hover:shadow-emerald-500/10 transition-all transform hover:-translate-y-1">
              <div className="flex items-center justify-between">
                <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
            <div className="bg-white rounded-lg shadow-md p-4 md:p-6">
              ...
              <button
                ...
                className="w-full flex items-center p-3 md:p-4 bg-emerald-50 hover:bg-emerald-100 rounded-lg transition-colors text-left"
              >
                <svg className="w-5 h-5 md:w-6 md:h-6 text-emerald-600 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" />
                </svg>
                <div>
